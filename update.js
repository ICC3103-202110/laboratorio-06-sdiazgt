...
/*
function rightUpdate(input2,input3,input4,model){
    if(input3==='Celsius'){
        if(input4==='Fahrenheit'){
            const newNumber = celsiusToFaren(input2)
        }
        else if(input4==='Kelvin'){
            const newNumber = celsiusToKelvin(input2)
        }
    }
    else if(input3==='Fahrenheit'){
        if(input4==='Celsius'){
            const newNumber = farenToCelsius(input2)
        }
        else if(input4==='Kelvin'){
            const newNumber = farenToKelvin(input2)
        }
    }
    else if (input3==='Kelvin'){
        if(input4==='Celsius'){
            const newNumber = kelvinToCelsius(input2)
        }
        else if(input4==='Fahrenheit'){
            const newNumber = kelvinToFaren(input2)
        }
    }
...
function leftUpdate(input2,input3,input4,model){
    if(input3==='Celsius'){
        if(input4==='Fahrenheit'){
            const newNumber = celsiusToFaren(input2)
        }
